    ...
    public static class ScenarioBuilder {
        ...
        public void runTest(TestContext context) {
            ...
            if(spectator.getPlayerList().getGameMode(spectator).orElseThrow() != to) {
                context.throwGameTestException(String.format("Expected spectator to have its real gamemode %s on its player list, but got %s", to, spectator.getPlayerList().getGameMode(spectator).orElseThrow()));
            }
