    ...
    public static class ScenarioBuilder {
        ...
        public void runTest(TestContext context) {
            ...
            if(spectator.getPlayerList().getGameMode(spectator).orElseThrow() != gameMode) {
                context.throwGameTestException(String.format("Expected spectator to have its real gamemode %s on its player list, but got %s", gameMode, spectator.getPlayerList().getGameMode(spectator).orElseThrow()));
            }

            if(observer.getPlayerList().getGameMode(spectator).orElseThrow() != expectedSpectatorGamemodeForObserver) {
                context.throwGameTestException(String.format(
